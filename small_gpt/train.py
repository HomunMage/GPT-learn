...
if __name__ == "__main__":
    ...
    for iter in range(max_iters):
        ...
        if iter % 1000 == 0 and iter > 0:
            torch.save(m.state_dict(), f"model_checkpoint_{iter}.pth")
            print(f"Saved checkpoint to model_checkpoint_{iter}.pth")

    torch.save(m.state_dict(), f"model_final.pth")
    print(f"Saved checkpoint to model_final.pth")
